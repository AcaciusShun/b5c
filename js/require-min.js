...
(function(ca) {
    ...
    function ha(b) {
        ...
        var X, $, i, N, Y, l = { waitSeconds: 30, baseUrl: "./", paths: {}, bundles: {}, pkgs: {}, shim: {}, config: {} },
            k = {},
            W = {},
            aa = {},
            A = [],
            ...
            enable: function() {
                ...
                v(this.depMaps, t(this, function(a, b) {
                    ...
                    if ("string" === typeof a) {
                        ...
                        this.depMaps[b] = a;
                        if (c = j(N, a.id)) { this.depExports[b] = c(this); return } this.depCount += 1;
            ...
            makeRequire: function(a, e) {
                function g(f, c, d) {
                    ...
                    if ("string" === typeof f) { if (G(c)) return w(C("requireargs", "Invalid require call"), d); if (a && s(N, f)) return N[f](k[a.id]); if (h.get) return h.get(i, f, a, g);
                        j = m(f, a, !1, !0);
                        j = j.id; return !s(p, j) ? w(C("notloaded", 'Module name "' + j + '" has not been loaded yet for context: ' + b + (a ? "" : ". Use require([])"))) : p[j] } L();
